      ...
      <div>
        ...
        <div className=" mt-2 py-2">
          ...
          <div className="mt-4 mb-4 md:mb-0 md:mr-4">
            <div className="w-full md:w-[400px] h-[151px] bg-gradient-to-br from-[#79F1A4] to-[#0E5CAD] rounded-lg flex">
                <div className="p-3">
                  <img
            ...
            <div className="mt-4">
              <div className="w-full md:w-[400px] h-[151px] bg-gradient-to-br from-[#FF9865] to-[#EF3031] rounded-lg flex">
                <div className="p-3">
                  <img
                    className="w-32 h-32 rounded-xl object-right object-cover"
